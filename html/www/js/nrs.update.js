...
var NRS = (function(NRS, $) {
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "wbx-client-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "wbx-client-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "wbx-client-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "wbx-client-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "wbx-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "wbx-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "wbx-client-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "wbx-client-", ext: "sh"}
	];
	...
	NRS.downloadClientUpdate = function(status, ext) {
        ...
        var fileurl = "https://bitbucket.org/JeanLucPicard/wbx/downloads/" + filename;
