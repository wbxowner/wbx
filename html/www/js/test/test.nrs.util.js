...
QUnit.test("convertToWIN", function (assert) {
    assert.equal(NRS.convertToWIN(200000000), "2", "whole");
    assert.equal(NRS.convertToWIN(20000000), "0.2", "fraction");
    assert.equal(NRS.convertToWIN(-200000000), "-2", "negative");
    assert.equal(NRS.convertToWIN(-20000000), "-0.2", "fraction.negative");
    assert.equal(NRS.convertToWIN(-220000000), "-2.2", "whole.fraction.negative");
    assert.equal(NRS.convertToWIN(2), "0.00000002", "nqt");
    assert.equal(NRS.convertToWIN(-2), "-0.00000002", "nqt.negative");
    assert.equal(NRS.convertToWIN(new BigInteger(String(2))), "0.00000002", "input.object");
    assert.equal(NRS.convertToWIN("hi"), "0.00000188", "alphanumeric"); // strange behavior of BigInteger don't do that
    assert.throws(function () {
        NRS.convertToWIN(null);
    }, {
...
QUnit.test("formatAmount", function (assert) {
    ...
    assert.equal(NRS.formatAmount("123456700000000", true, true), Number("1234567").toLocaleString(), "wbx.rounding");
...
QUnit.test("getAccountLink", function (assert) {
    ...
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831 }, "entity"), "<a href='#' data-user='WBX-XKA2-7VJU-VZSY-7R335' class='show_account_modal_action user-info'>/</a>", "numeric");
    assert.equal(NRS.getAccountLink({ entityRS: "WBX-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='WBX-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>WBX-XK4R-7VJU-6EQG-7R335</a>", "RS");
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831, entityRS: "WBX-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='WBX-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>WBX-XK4R-7VJU-6EQG-7R335</a>", "numeric.and.RS");
    NRS.contacts = { "WBX-XK4R-7VJU-6EQG-7R335": { name: "foo" }};
    assert.equal(NRS.getAccountLink({ entityRS: "WBX-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='WBX-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>foo</a>", "contact");
    NRS.accountRS = "WBX-XK4R-7VJU-6EQG-7R335";
    assert.equal(NRS.getAccountLink({ entityRS: "WBX-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='WBX-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>You</a>", "you");
    assert.equal(NRS.getAccountLink({ entityRS: "WBX-XK4R-7VJU-6EQG-7R335" }, "entity", "WBX-XK4R-7VJU-6EQG-7R335", "My Precious"), "<a href='#' data-user='WBX-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>My Precious</a>", "force.account.name");
    assert.equal(NRS.getAccountLink({ entityRS: "WBX-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, true), "<a href='#' data-user='WBX-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>WBX-XK4R-7VJU-6EQG-7R335</a>", "maintain.rs.format");
    assert.equal(NRS.getAccountLink({ entityRS: "WBX-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, undefined, "btn btn-xs"), "<a href='#' data-user='WBX-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info btn btn-xs'>You</a>", "add.class");
    NRS.contacts = null;
    NRS.accountRS = null;
    NRS.constants.GENESIS = 1739068987193023818;
    NRS.constants.GENESIS_RS = "WBX-MR8N-2YLS-3MEQ-3CMAJ";
    assert.equal(NRS.getAccountLink({ entityRS: NRS.constants.GENESIS_RS }, "entity"), "<a href='#' data-user='WBX-MR8N-2YLS-3MEQ-3CMAJ' class='show_account_modal_action user-info'>Genesis</a>", "genesis");
});
