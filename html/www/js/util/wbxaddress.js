...
/*
    WBX address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: WinChg (admin@winchg.com).
*/
...
function WbxAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('WBX-') == 0) adr = adr.substr(4);
