...
var NRS = (function(NRS, $) {
    ...
    NRS.addTreeviewSidebarMenuItem = function(options) {
        ...
        menuHTML += '<a href="#" data-page="' + options["page"] + '">' + options["titleHTML"] + '</a>'; // barton 7-1-2017  removed  <i class="fa pull-right fa-angle-right" style="padding-top:3px"></i>
    ...
    NRS.appendMenuItemToTSMenuItem = function(itemId, options) {
        ...
        } else if (options["type"] == 'ACTION' && options["action"]) { // add "action" menu item type  -  barton 7-4-2017
            menuHTML += 'data-toggle="modal" onclick="' + options["action"] + '"';
        } else if (options["type"] == 'LINK' && options["href"]) { // add "action" menu item type  -  barton 7-4-2017
            menuHTML += 'data-toggle="modal" target="_blank" href="' + options["href"] + '"';
        } else {
            return false;
        }
        // menuHTML += '><i class="fa fa-angle-double-right"></i> ';  // barton 7-1-2017
        menuHTML += '>&nbsp;&nbsp;&nbsp;';   // barton 7-1-2017
