...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount WBX",
			labelI18n: "amount_wbx",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumWIN",
			addonText: "WBX",
			addonI18n: "wbx_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_wbx', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceWIN';
		context['addonText'] = 'WBX';
		context['addonI18n'] = 'wbx_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_wbx', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
