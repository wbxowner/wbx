...
import wbx.Wbx;
import wbx.env.service.WbxService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/wbx.manifest.mf", Wbx.class.getCanonicalName(), "./lib");
        String serviceClassName = WbxService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/winservice.manifest.mf", serviceClassName, "./lib");
    }
