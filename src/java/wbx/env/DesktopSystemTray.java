...
public class DesktopSystemTray {
    ...
    void createAndShowGUI() {
        ...
        imageIcon = new ImageIcon("html/www/img/wbx-icon-32x32.png", "tray icon");
        ...
        if (!Wbx.isDesktopApplicationEnabled()) {
    ...
    private void displayStatus() {
        ...
        addDataRow(statusPanel, "Application", Wbx.APPLICATION);
        addDataRow(statusPanel, "Version", Wbx.VERSION);
        ...
        addDataRow(statusPanel, "User folder", String.valueOf(Paths.get(Wbx.getUserHomeDir()).toAbsolutePath()));
        ...
        if (lastBlock != null) {
            ...
            addDataRow(statusPanel, "Seconds passed", String.valueOf(Wbx.getEpochTime() - lastBlock.getTimestamp()));
        ...
        addDataRow(statusPanel, "Process id", Wbx.getProcessId());
        addEmptyRow(statusPanel);
