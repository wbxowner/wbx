...
public final class Constants {
    ...
    public static final String COIN_NAME = "WBX";
    public static final boolean isTestnet = Wbx.getBooleanProperty("wbx.isTestnet");
    public static final boolean isOffline = Wbx.getBooleanProperty("wbx.isOffline");
    public static final boolean isLightClient = Wbx.getBooleanProperty("wbx.isLightClient");

    public static final int MAX_NUMBER_OF_TRANSACTIONS = 255;
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long MAX_BALANCE_WIN = 21000000;
    public static final long ONE_WIN = 100000000;
    //public static final long TRANSACTION_FEE = ONE_WIN / Wbx.getIntProperty("wbx.reductorFee", 1); //suse
    public static final long REDUCTOR_FEE = Wbx.getIntProperty("wbx.reductorFee", 1); //suse
    public static final long MAX_BALANCE_NQT = MAX_BALANCE_WIN * ONE_WIN;
    public static final long INITIAL_BASE_TARGET = 153722867;
    public static final long MAX_BASE_TARGET = MAX_BALANCE_WIN * INITIAL_BASE_TARGET;
    ...
    public static final int MAX_ROLLBACK = Math.max(Wbx.getIntProperty("wbx.maxRollback"), 720);
    //public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Wbx.getIntProperty("wbx.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Wbx.getIntProperty("wbx.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? Wbx.getIntProperty("wbx.testnetLeasingDelay", 1440) : 1440;
    //suse public static final int MAX_LEASING_PERIOD = 65535;
    public static final int MAX_LEASING_PERIOD = 65535;
    public static final long MIN_FORGING_BALANCE_NQT = 2000 * ONE_WIN;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = Wbx.getIntProperty("wbx.forgingDelay");
    public static final int FORGING_SPEEDUP = Wbx.getIntProperty("wbx.forgingSpeedup");
    ...
    static {
        int maxPrunableLifetime = Wbx.getIntProperty("wbx.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = Wbx.getBooleanProperty("wbx.includeExpiredPrunable");
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_WIN;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_WIN;

    public static final boolean correctInvalidFees = Wbx.getBooleanProperty("wbx.correctInvalidFees");
    ...
    public static final String SECRETPHRASE_PREFIX = "wbx";
