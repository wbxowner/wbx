...
import wbx.Currency;
import wbx.CurrencyBuyOffer;
import wbx.CurrencySellOffer;
...
import static wbx.http.JSONResponses.*;
...
public final class ParameterParser {
    ...
    public static int getNumberOfConfirmations(HttpServletRequest req) throws ParameterException {
        return getInt(req, "numberOfConfirmations", 0, Wbx.getBlockchain().getHeight(), false);
    }
    ...
    public static long getHoldingId(HttpServletRequest req, HoldingType holdingType) throws ParameterException {
        long holdingId = ParameterParser.getUnsignedLong(req, "holding", holdingType != HoldingType.WBX);
        if (holdingType == HoldingType.WBX && holdingId != 0) {
    ...
    public static Transaction.Builder parseTransaction(String transactionJSON, String transactionBytes, String prunableAttachmentJSON) throws ParameterException {
        ...
        if (transactionJSON != null) {
            try {
                ...
                return Wbx.newTransactionBuilder(json);
            } catch (WbxException.ValidationException | RuntimeException | ParseException e) {
            ...
            try {
                ...
                return Wbx.newTransactionBuilder(bytes, prunableAttachments);
            } catch (WbxException.ValidationException|RuntimeException | ParseException e) {
                Logger.logDebugMessage(e.getMessage(), e);
                JSONObject response = new JSONObject();
    ...
    public static Attachment.TaggedDataUpload getTaggedData(HttpServletRequest req) throws ParameterException, WbxException.NotValidException {
