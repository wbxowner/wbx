...
/**
 * Issue a currency on the WBX blockchain
 * <p>
 * A currency is the basic block of the WBX Monetary System it can be exchanged with WBX, transferred between accounts,
 ...
 * For {@link wbx.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum WBX value per unit to allow the currency to become active
 * For {@link wbx.CurrencyType#RESERVABLE} currency
 ...
 * For {@link wbx.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link wbx.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link wbx.crypto.HashFunction algorithm} used for minting.
 * For {@link wbx.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link wbx.CurrencyType#EXCHANGEABLE} nor {@link wbx.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link wbx.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link wbx.CurrencyType#RESERVABLE} becomes active, in case it is {@link wbx.CurrencyType#CLAIMABLE} the WBX used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link wbx.CurrencyType#RESERVABLE} becomes active, in case it is non {@link wbx.CurrencyType#CLAIMABLE} the WBX used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link wbx.CurrencyType#MINTABLE} currency, the number of units per {@link wbx.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link wbx.http.CurrencyMint}<br>
 * </ul>
 *
 * @see wbx.CurrencyType
 * @see wbx.crypto.HashFunction
 */
