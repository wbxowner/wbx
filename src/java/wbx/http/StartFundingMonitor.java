...
import static wbx.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static wbx.http.JSONResponses.UNKNOWN_ACCOUNT;
import static wbx.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer WBX, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * WBX amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  WbxException        Unable to process request
     */
    @Override
