...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("application", Wbx.APPLICATION);
        response.put("version", Wbx.VERSION);
        response.put("time", Wbx.getEpochTime());
        ...
        response.put("currentMinRollbackHeight", Wbx.getBlockchainProcessor().getMinRollbackHeight());
