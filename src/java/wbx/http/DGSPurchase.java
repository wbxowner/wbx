...
import static wbx.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static wbx.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static wbx.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static wbx.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws WbxException {
        ...
        try {
            ...
            if (deliveryDeadline <= Wbx.getEpochTime()) {
