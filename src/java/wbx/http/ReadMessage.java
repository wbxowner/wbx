...
import static wbx.http.JSONResponses.NO_MESSAGE;
import static wbx.http.JSONResponses.PRUNED_TRANSACTION;
...
public final class ReadMessage extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        Transaction transaction = Wbx.getBlockchain().getTransaction(transactionId);
        if (transaction == null) {
