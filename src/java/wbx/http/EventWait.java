...
import wbx.http.EventListener.PendingEvent;
 ...
 * wbx.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than wbx.apiEventTimeout.</li>
 * </ul>
 *
