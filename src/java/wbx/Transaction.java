...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws WbxException.NotValidException;

        Transaction build(String secretPhrase) throws WbxException.NotValidException;
    ...
    void validate() throws WbxException.ValidationException;
