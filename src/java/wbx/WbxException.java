...
public abstract class WbxException extends Exception {

    protected WbxException() {
        super();
    }

    protected WbxException(String message) {
        super(message);
    }

    protected WbxException(String message, Throwable cause) {
        super(message, cause);
    }

    protected WbxException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends WbxException {
    ...
    public static final class WbxIOException extends IOException {

        public WbxIOException(String message) {
            super(message);
        }

        public WbxIOException(String message, Throwable cause) {
            super(message, cause);
        }
