...
import static wbx.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Transaction> transactions = Wbx.getTransactionProcessor().getAllUnconfirmedTransactions()) {
            ...
            int blockchainHeight = Wbx.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = Wbx.getBlockchain().getBlocks(accountId, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Wbx.getBlockchain().getTransactions(accountId, (byte) -1, (byte) -1, 0, false)) {
