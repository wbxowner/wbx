...
import static wbx.user.JSONResponses.DENY_ACCESS;
import static wbx.user.JSONResponses.INCORRECT_REQUEST;
import static wbx.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws WbxException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = Wbx.getBooleanProperty("wbx.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|WbxException e) {
