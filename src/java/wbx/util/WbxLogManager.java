...
/**
 * Java LogManager extension for use with Wbx
 */
public class WbxLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the Wbx log manager
     *
     ...
     * done terminating the Wbx processes.
     */
    public WbxLogManager() {
        super();
    }
     ...
     * This allows us to continue to use logging facilities during Wbx shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * Wbx shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void wbxShutdown() {
        super.reset();
