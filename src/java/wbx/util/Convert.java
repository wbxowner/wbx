...
//        return "WBX-" + Crypto.rsEncode(accountId);
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws WbxException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new WbxException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseWIN(String wbx) {
        return parseStringFraction(wbx, 8, Constants.MAX_BALANCE_WIN);
    }
