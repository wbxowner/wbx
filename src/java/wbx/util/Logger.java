...
/**
 * Handle logging for the Wbx node server
 */
public final class Logger {
     ...
     * The wbx/conf/logging-default.properties and wbx/conf/logging.properties configuration
    ...
    static {
        ...
        System.setProperty("java.util.logging.manager", "wbx.util.WbxLogManager");
        if (!(LogManager.getLogManager() instanceof WbxLogManager)) {
            System.setProperty("java.util.logging.manager",
                    (oldManager != null ? oldManager : "java.util.logging.LogManager"));
        }
        if (! Boolean.getBoolean("wbx.doNotConfigureLogging")) {
            try {
                Properties loggingProperties = new Properties();
                Wbx.loadProperties(loggingProperties, "logging-default.properties", true);
                Wbx.loadProperties(loggingProperties, "logging.properties", false);
                Wbx.updateLogFileHandler(loggingProperties);
        ...
        log = org.slf4j.LoggerFactory.getLogger(wbx.Wbx.class);
        enableStackTraces = Wbx.getBooleanProperty("wbx.enableStackTraces");
        enableLogTraceback = Wbx.getBooleanProperty("wbx.enableLogTraceback");
    ...
    public static void shutdown() {
        if (LogManager.getLogManager() instanceof WbxLogManager) {
            ((WbxLogManager) LogManager.getLogManager()).wbxShutdown();
        }
    }
