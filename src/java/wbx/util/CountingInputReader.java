...
import wbx.WbxException.WbxIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  WbxIOException      Maximum count exceeded
     */
    private void incCount(long c) throws WbxIOException {
        count += c;
        if (count > limit)
            throw new WbxIOException("Maximum size exceeded: " + count);
    }
}
