...
### Database ###
  ...
  - main database: `wbx_db/`
  - test database: `wbx_test_db/`
  ...
  - use the wbx.db framework when accessing the database from your code
...
The WBX wallet UI run as a mobile app.
...
6. Under the <WINRoot>\mobile\app folder execute the command:
createapp.bat
